...
export default function BenefitsRow() {
    const benefits = [
        ...
        },
        {
            ...
            bg: "bg-[var(--color-main)]/5 border-[var(--color-main)]/10"
        }
    ];

    return (
        <section className="py-12 bg-[var(--background)] border-t border-b border-white/5 relative z-10 w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {benefits.map((benefit, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className={`p-3 rounded-xl bg-white/5 ${benefit.color} flex-shrink-0`}>
                                    <Icon className="w-6 h-6" />
                                </div>
                                <div className="space-y-1">
                                    <h4 className="font-extrabold text-sm uppercase tracking-wider text-[var(--foreground)]">
                                        {benefit.title}
                                    </h4>
