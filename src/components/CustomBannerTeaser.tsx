...
export default function CustomBannerTeaser() {
    ...
    return (
        <section className="py-16 my-8 bg-linear-to-b from-transparent via-main/5 to-transparent relative overflow-hidden border-y border-white/5">
            {/* Ambient Background Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-75 bg-main/10 blur-[130px] rounded-full pointer-events-none" />

            <div className="container mx-auto px-6 md:px-8 max-w-350 relative z-10">
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                    <div className="max-w-2xl">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-main/15 border border-main/30 text-emerald-400 text-xs font-bold uppercase tracking-wider mb-4">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tight text-white leading-tight">
                            Diseñá tu propia remera en <span className="bg-linear-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent">3 pasos simples</span>
                        </h2>
                    </div>

                    <button
                        onClick={scrollToCustomizer}
                        className="px-6 py-3.5 rounded-xl bg-linear-to-r from-emerald-500 to-main text-white font-extrabold text-xs uppercase tracking-wider shadow-lg shadow-emerald-900/30 hover:scale-105 transition-all flex items-center gap-2 cursor-pointer group"
                    >
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center justify-between mb-6">
                                    <div className="p-3.5 rounded-xl bg-main/20 text-emerald-400 border border-main/30 group-hover:scale-110 transition-transform">
