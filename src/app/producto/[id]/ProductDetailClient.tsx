        ...
        <div className="min-h-screen bg-background pt-24 pb-20 font-sans">
            <div className="container mx-auto px-4 md:px-8 max-w-7xl">
                ...
                <div className="mb-6">
                    <Link
                        href="/#productos"
                        className="inline-flex items-center text-sm font-semibold text-gray-500 hover:text-main transition-colors uppercase tracking-wider gap-2 group"
                    >
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col-reverse md:flex-row gap-4">
                        ...
                        <div className="relative w-full aspect-3/4 bg-gray-100 dark:bg-zinc-900 rounded-xl overflow-hidden flex-1 group">
                            ...
                            {product.isNew && (
                                <span className="absolute top-4 left-4 z-10 bg-main text-white text-xs font-bold px-3 py-1 uppercase tracking-wider rounded">
                                    Nuevo
                                </span>
                            )}
                        </div>
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center">
                        ...
                        >
                            ...
                            <p className="text-3xl font-light text-main mb-8">
                            ...
                            <div className="mb-8">
                                <div className="flex justify-between items-center mb-3">
                                    ...
                                    <button 
                                        ...
                                        className="text-xs text-gray-500 underline hover:text-main transition-colors"
                                    >
                                        Guía de Tallas
                                    </button>
                                </div>
                                    ...
                                    {sizes.map((size) => (
                                        <button
                                            ...
                                            className={`py-4 rounded border text-sm font-bold transition-all ${selectedSize === size
                                                    ? "border-main bg-main text-white shadow-lg transform -translate-y-1"
                                                    : "border-gray-200 dark:border-zinc-800 text-gray-800 dark:text-gray-200 hover:border-main"
                                                }`}
                                        >
                                            {size}
                                        </button>
                            ...
                            <div className="space-y-4 mb-10">
                                <button
                                    ...
                                    className="w-full py-5 bg-foreground text-background rounded font-bold flex items-center justify-center gap-3 hover:bg-main hover:text-white transition-all transform hover:-translate-y-1 hover:shadow-xl hover:shadow-main/30 uppercase tracking-widest text-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none"
                                >
                                ...
                                <button
                                    ...
                                    disabled={!selectedSize}
                                    className="w-full py-4 border-2 border-main/60 text-main rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-main hover:text-white transition-all transform hover:-translate-y-1 hover:shadow-lg hover:shadow-main/30 uppercase tracking-widest text-sm disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none cursor-pointer"
                                >
                ...
                {relatedProducts && relatedProducts.length > 0 && (
                    ...
                    >
                        <h3 className="text-2xl font-bold tracking-tight text-center mb-12 uppercase text-foreground">
                            Completa tu estilo
                        </h3>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="text-xs text-gray-400 leading-relaxed border-t border-gray-100 dark:border-zinc-800 pt-4 flex flex-col gap-1.5">
