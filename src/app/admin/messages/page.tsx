...
export default function AdminMessagesPage() {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
            ...
            <div className="mb-10 pt-4 flex flex-col md:flex-row justify-between md:items-end gap-4 border-b border-[#242520] pb-6">
                <div>
                    <h1 className="text-4xl font-extrabold tracking-tight text-[#f9f5f8] mb-2 font-['Manrope']">Mensajes de Contacto</h1>
                    <p className="text-[#adaaad] max-w-2xl text-sm font-medium">Gestiona y responde las consultas enviadas por los clientes desde la web.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 lg:col-span-3 space-y-6">
                    <div className="bg-[#19191c] p-6 rounded-xl border border-[#48474a]/10 space-y-4">
                        <h3 className="text-xs font-bold uppercase tracking-widest text-[#adaaad]">Carpetas</h3>
                        <div className="space-y-1">
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm">Todos los Mensajes</span>
                                </div>
                    ...
                    <div className="bg-[#19191c] p-6 rounded-xl border border-[#48474a]/10 space-y-4">
                        <h3 className="text-xs font-bold uppercase tracking-widest text-[#adaaad]">Etiquetas</h3>
                        <div className="flex flex-wrap gap-2">
                            <span className="bg-[#69f6b8]/10 text-[#69f6b8] border border-[#69f6b8]/20 px-3 py-1 rounded-full text-xs font-medium cursor-pointer hover:bg-[#69f6b8]/20 transition-colors">Soporte</span>
                            <span className="bg-[#ac8aff]/10 text-[#ac8aff] border border-[#ac8aff]/20 px-3 py-1 rounded-full text-xs font-medium cursor-pointer hover:bg-[#ac8aff]/20 transition-colors">Consultas</span>
                            <span className="bg-[#262528] text-[#adaaad] border border-[#48474a]/10 px-3 py-1 rounded-full text-xs font-medium cursor-pointer hover:bg-[#2c2c2f] transition-colors">Comentarios</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-[#19191c] rounded-xl overflow-hidden shadow-xl border border-[#48474a]/10 relative min-h-[500px]">
                        ...
                        <div className="px-6 py-4 flex flex-col sm:flex-row gap-4 items-center justify-between bg-[#1f1f22]/50 border-b border-[#48474a]/10">
                            <div className="flex items-center gap-4 w-full sm:w-auto">
                                ...
                                <button className="text-[#adaaad] hover:text-[#f9f5f8] transition-colors p-2 bg-[#131315] rounded-lg border border-[#48474a]/10 hover:border-[#48474a]/30" onClick={fetchMessages} title="Actualizar Mensajes">
                                    <RefreshCw className="w-4 h-4" />
                                </button>
                            </div>
                            <div className="flex items-center gap-4 text-xs font-medium text-[#adaaad] w-full sm:w-auto justify-end">
                                <span>Mostrando {filteredMessages.length} de {messages.length}</span>
                            </div>
                        </div>
                        ...
                        <div className="divide-y divide-[#48474a]/10 h-[600px] overflow-y-auto custom-scrollbar relative">
                            {filteredMessages.length === 0 ? (
                                <div className="px-6 py-24 text-center text-[#adaaad] absolute inset-0 flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-lg font-bold text-[#f9f5f8]">Bandeja Limpia</p>
                                    <p className="mt-1">No hay mensajes pendientes por revisar.</p>
                                </div>
                            ) : (
                                    ...
                                    <div key={msg.id} className={`px-6 py-6 flex flex-col md:flex-row md:items-center gap-4 hover:bg-[#1f1f22] transition-colors cursor-pointer group relative ${msg.status === 'unread' ? '' : 'opacity-80'}`}>
                                        ...
                                        <div className="flex-grow min-w-0 pr-4 pl-8 md:pl-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                {msg.status === 'unread' && <span className="bg-[#ff716c]/20 flex-shrink-0 text-[#ff716c] text-[9px] px-2 py-0.5 rounded-full font-extrabold uppercase">Nuevo</span>}
                                            </div>
