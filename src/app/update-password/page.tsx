            ...
            <div className="w-full max-w-md p-8 bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-3xl shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full py-4 bg-(--foreground) text-(--background) rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-main hover:text-white transition-all duration-300 disabled:opacity-50"
                    >
                        {isLoading ? (
